...
def create_output_directory(output_dir="network_visualizations"):
...
def main():
    ...
    parser.add_argument("--analysis-file", default="full_analysis/textbook_ksao_analysis.txt", 
                        help="File containing the textbook analysis")
    parser.add_argument("--output-dir", default="network_visualizations", 
